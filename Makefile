...
build:
	...
	cd cmd/mongo && GOARCH=amd64 CGO_ENABLED=1 go build -o release/${NAME}_x64.dll -buildmode=c-shared

	${call colored,building x86...}
	cd cmd/mongo && GOARCH=386 CGO_ENABLED=1 go build -o release/${NAME}.dll -buildmode=c-shared
